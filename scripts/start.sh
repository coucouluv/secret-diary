...
sudo docker build --build-arg IDLE_PROFILE=${IDLE_PROFILE} -f /home/ec2-user/secret-diary/Dockerfile -t ${IDLE_PROFILE} /home/ec2-user/secret-diary >> /home/ec2-user/deploy.log 2>/home/ec2-user/deploy_err.log
sleep 30
